variable "name_prefix" {
  type        = string
  description = "Short prefix used in all resource names (e.g. 'mr-secure-test')."
}
...
variable "storage_account_name_prefix" {
  type        = string
  description = "Prefix for storage account names. Lowercase alphanumeric, max 21 chars."
}
